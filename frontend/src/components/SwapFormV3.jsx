              ...
              <div className="text-right">
                <div className="text-xs text-gray-500 dark:text-gray-400">
                  {sellAmount && sellAmount !== '0' && sellToken && tokenPrices[sellToken.symbol] ? (
                    <span>≈ ${(parseFloat(sellAmount) * tokenPrices[sellToken.symbol]).toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</span>
                  ) : (
        ...
        <div className="mb-2">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-xs text-gray-500 dark:text-gray-400">
                  {buyAmount && buyAmount !== '0' && buyToken && tokenPrices[buyToken.symbol] ? (
                    <span>≈ ${(parseFloat(buyAmount) * tokenPrices[buyToken.symbol]).toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</span>
                  ) : (
                    <span className="text-gray-400">$--</span>
                  )}
                </div>
